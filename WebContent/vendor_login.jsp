...
<body>
	...
	<div class="container">
		<div class="col-md-4 offset-md-4">
			...
			<div class="card">
				<div class="card-header text-center bg-warning">LOGIN AS
					VENDOR</div>
				...
				<div class="card-body">
					<form method="post" action="Vendor_login_servlet">
						<div class="mb-3">
							<label for="Email" class="form-label">Email address</label> <input
								name="vendor_email" type="email" class="form-control" id="Email">

						</div>
						<div class="mb-3">
							<label for="Password1" class="form-label">Password</label> <input
								name="vendor_password" type="password" class="form-control"
								id="Password1">
						</div>
