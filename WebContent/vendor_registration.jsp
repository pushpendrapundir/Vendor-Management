...
<div class="col-md-4 offset-md-4"  >
					...
					%>
						...
						<div class="card-body">
							<form action="Vendor_register_servlet" method="post">
							
							<div class="mb-3">
									<label for="Full Name" class="form-label">Full
										Name</label> <input type="text" class="form-control"
										id="Name" name="vendor_name">
									
								</div>
								<div class="mb-3">
									<label for="Email" class="form-label">Email
										address</label> <input name="vendor_email" type="email" class="form-control"
										id="Email">
									
								</div>
								<div class="mb-3">
									<label for="Password1" class="form-label">Password</label>
									<input name="vendor_password" type="password" class="form-control"
										id="Password1">
								</div>
								<div class="mb-3">
									<label for="Password1" class="form-label">Confirm Password</label>
									<input name="vendor_cpassword" type="password" class="form-control"
										id="Password1">
								</div>
